...
import com.byted.camp.todolist.NoteChangeActivity;
...
public class NoteViewHolder extends RecyclerView.ViewHolder {
    ...
    public void bind(final Note note) {
        ...
        //      TODO 2 长按修改TODOLIST内容
        contentText.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                Intent intent = new Intent(v.getContext(),
                        NoteChangeActivity.class);
                Bundle bundle = new Bundle();
                bundle.putLong("key",note.id);
                intent.putExtras(bundle);
                ((Activity)v.getContext()).startActivityForResult(intent,REQUEST_CODE_CHANGE);
                return false;
            }
        });
